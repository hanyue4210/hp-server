...
public interface BasicMapper {
     ...
     * @return
     */
    Integer deleteTowers(String regionId);
     ...
     * @return
     */
    Integer deleteCells(String towerId);
     ...
     * @return
     */
    Integer countCells(String towerId);
     ...
     * @return
     */
    Integer countGroup(BasicGroupVo dto);
     ...
     * @return
     */
    Integer countSite(BasicSiteVo dto);
     ...
     * @return
     */
    List<BasicRegionVo> getRegionTree(Long companyId);

    List<BasicTowerVo> getTowerTree(Long regionId);

    List<BasicCellVo> getCellTree(Long towerId);
     ...
     * @return
     */
    List<BasicGroupVo> getGroupTree(Long companyId);

    List<BasicSiteVo> getSiteTree(Long groupId);

    List<BasicUnitVo> getUnitTree(Long SiteId);
