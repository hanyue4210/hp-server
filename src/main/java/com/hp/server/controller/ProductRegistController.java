...
public class ProductRegistController {
     ...
     */
    @PostMapping("/save")
    public ResultBody save(@RequestBody @Valid ProductRegistVo vo) {
     ...
     */
    @GetMapping("/getLists")
    public ResultBody getLists(@Valid ProductRegistDTO dto) {
